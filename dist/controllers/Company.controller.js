...
export const registerCompany = async (companyName, email, passwordHash, name) => {
...
export const generateKeyPair = async (companyId) => {
    // 1. Generate Raw Keys
...
export const deleteKeyPair = async (companyId) => {
...
export const getPublicKey = async (companyId) => {
    // 3. Save to Database
