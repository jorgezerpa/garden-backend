...
export const getManagersPaginated = async (skip, take, companyId) => {
...
export const deleteManagerAndUser = async (id) => {
    return await prisma.$transaction(async (tx) => {
...
export const upsertAgentThirdParty = async (id, data) => {
...
export const getAgentsPaginated = async (skip, take, companyId) => {
    const [total, data] = await prisma.$transaction([
...
export const deleteAgentAndUser = async (id) => {
