...
schemaRouter.post('/create', async (req: Request, res: Response) => {
  try {
    const { name, type, companyId, creatorId, days } = req.body;
...
schemaRouter.get('/list/:companyId', async (req: Request, res: Response) => {
  try {
...
schemaRouter.put('/update/:id', async (req: Request, res: Response) => {
